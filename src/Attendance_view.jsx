...
const Attendance_display_function=(prop)=>{
...
const Attendance_view=()=>
{
    ...
    <>
        ...
        <Students_Drawer left_component={<Attendance_display_function login_name_val={login_data.Username}/>}/>
    </>
    );

}
export default Attendance_view;