...
const Teacher_sign_up_form=()=>
{
    ...
    const form_submit=(event)=>
    {
        ...
        const Sign_up_obj={
            ...
            Org_name:signUpcredentials.sign_up_org_name
        }
        axios.post(`http://Localhost/school_dashboard/Teacher_Sign_up_page_insert.php`, Sign_up_obj).then(res=>console.log(res.data)).catch((error)=>console.log(error));
        ...
        const View = async ()=>
        { 
          const res = await axios.get(`http://Localhost/school_dashboard/Teacher_Sign_up_page_insert.php`);
...
export default Teacher_sign_up_form;